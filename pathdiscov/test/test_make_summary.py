...
from pathdiscov.make_summary import MissingProjectFile
...
class TestN50(BaseTest):
    def _C(self, *args, **kwargs):
        from pathdiscov.make_summary import get_n50
    ...
    def test_mockproj_contig_n50(self):
        from pathdiscov.make_summary import parse_tab_file
        print self.mockproj
...
class TestReadCount( BaseTest ):
    ...
    def _C( self, *args, **kwargs ):
        from pathdiscov.make_summary import read_count
...
class TestTotalReads( BaseTest ):
    def _C( self, *args, **kwargs ):
        from pathdiscov.make_summary import total_reads
...
class TestNonHostNumReads( BaseTest ):
    def _C( self, *args, **kwargs ):
        from pathdiscov.make_summary import non_host_num_reads
...
class TestNumContig( BaseTest ):
    def _C( self, *args, **kwargs ):
        from pathdiscov.make_summary import num_contig
...
class TestR1R2Count( BaseTest ):
    def _C( self, *args, **kwargs ):
        from pathdiscov.make_summary import r1r2_count
...
class TestContigInfo( BaseTest ):
    def _C( self, *args, **kwargs ):
        from pathdiscov.make_summary import contig_info
...
class TestContigsFor( BaseTest ):
    def _C( self, *args, **kwargs ):
        from pathdiscov.make_summary import contigs_for
...
class TestUnassembledReads( BaseTest ):
    def _C( self, *args, **kwargs ):
        from pathdiscov.make_summary import unassembled_reads
...
class TestSummary( BaseTest ):
    ...
    def _C( self, *args, **kwargs ):
        from pathdiscov.make_summary import summary
...
class TestFormatSummary( BaseTest ):
    def _C( self, *args, **kwargs ):
        from pathdiscov.make_summary import format_summary
...
class TestFormatDic( BaseTest ):
    def _C( self, *args, **kwargs ):
        from pathdiscov.make_summary import format_dict
