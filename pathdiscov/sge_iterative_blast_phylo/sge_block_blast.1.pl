...
#	print "[cmd] ",$cmd,"\n";
#	system($cmd);	
	my $qcmd="qsub -V -N blast".$i.".R".$r.".".$j." -e ../logs_blast -o ../logs_blast -l mem=".$qmem."G,time=".$qtime.":: -S /usr/bin/perl -cwd $cmd";	
	print "[qcmd] ",$qcmd,"\n";
...
my $qcmd="qsub -V -hold_jid $jid_list -N blastfin.R".$r.".".$j." -e ../logs_blast -o ../logs_blast -l mem=1G,time=1:: -S /bin/sh -cwd $path_scripts/job_release_concat_blast.sh $qrls $outfile";	
print "[qcmd] ",$qcmd,"\n";
my $qsub_message=`$qcmd`;	
print($qsub_message); 
