...
print_system("$path_scripts/pathogen.pl --sample $sample --command step1 host_map quality_filter ray2_assembly iterative_blast_phylo orf_filter iterative_blast_phylo_3 --paramfile param.txt --outputdir $outputdir --R1 $r1 --R2 $r2");
