...
# example
# block_blast.pl --inputfasta x --outputdir x --outfile x --outheader x --ninst 5 --db x --blast_type x --task x --blast_options x

# declare vars
my ($outputdir, $inputfasta, $outfile, $outheader, $ninst, $db, $blast_type, $task, $blast_options);
